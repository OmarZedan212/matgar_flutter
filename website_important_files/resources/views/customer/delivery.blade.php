...
<div style="width: 1000px;margin: auto;" class="form-card">
    <header class="content-header"><h2 style="margin: 0px;text-align: center;">Order Information</h2></header>

    <form action="{{ route('delivery.confirm') }}" method="POST">
        @csrf
