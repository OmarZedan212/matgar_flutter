            ...
            <form id="storeForm">
                ...
                <div class="row">
                    <div class="input-group">
                        ...
                        <input
                            ...
                            id="storeName"
                            name="shop_name"
                            value="{{ old('shop_name', $hasSeller ? $seller->shop_name : '') }}"
                            required
                        >
                    </div>
                </div>
                ...
                <div class="input-group">
                    ...
                    <textarea
                        ...
                        name="description"
                        rows="3"
                    >{{ old('description', $hasSeller ? $seller->description : '') }}</textarea>
                </div>
                ...
                <div class="row">
                    <div class="input-group">
                        ...
                        <input
                            ...
                            id="storeEmail"
                            name="business_email"
                            value="{{ old('business_email', $hasSeller ? $seller->business_email : '') }}"
                            required
                        >
                    </div>
                    <div class="input-group">
                        ...
                        <input
                            ...
                            id="storePhone"
                            name="support_phone"
                            value="{{ old('support_phone', $hasSeller ? $seller->support_phone : '') }}"
                        >
                    </div>
                </div>
                ...
                <div class="input-group">
                    ...
                    <input
                        ...
                        id="storeAddress"
                        name="address"
                        value="{{ old('address', $hasSeller ? $seller->address : '') }}"
                    >
                </div>
                ...
                <div class="row">
                    <div class="input-group">
                        ...
                        <input
                            ...
                            id="storeFb"
                            name="facebook_page"
                            value="{{ old('facebook_page', $hasSeller ? $seller->facebook_page : '') }}"
                    ...
                    <div class="input-group">
                        ...
                        <input
                            ...
                            value="{{ old('instagram_profile', $hasSeller ? $seller->instagram_profile : '') }}"
                ...
                <div class="form-actions" style="margin-top:30px;">
                    <button class="btn-primary" type="submit" style="padding:12px 30px; font-size:1rem;">
                        ...
                        @elseif($hasSeller)
                        <i class="fa-solid fa-save"></i> Update Request Data
                        @else
